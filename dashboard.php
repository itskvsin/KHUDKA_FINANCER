...
$total_expense = $expenseRow['total_expense'] ?? 0;

// Fetch total savings
$savingQuery = "SELECT SUM(current_saving) AS total_savings FROM saving WHERE user_id = '$user_id'";
$savingResult = mysqli_query($conn, $savingQuery);
$savingRow = mysqli_fetch_assoc($savingResult);
$total_savings = $savingRow['total_savings'] ?? 0;
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            var data = google.visualization.arrayToDataTable([
                ...
                ['Total Savings', <?php echo $total_savings; ?>]
            ]);
